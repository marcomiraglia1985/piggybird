...
INSERT INTO "new_Transaction" ("accountId", "amount", "beneficiary", "categoryId", "createdAt", "date", "id", "isJoint", "month", "notes", "transferGroupId", "updatedAt", "year") SELECT "accountId", "amount", "beneficiary", "categoryId", "createdAt", "date", "id", "isJoint", "month", "notes", "transferGroupId", "updatedAt", "year" FROM "Transaction";
